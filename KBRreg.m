...
function Y  =  KBRreg(D,beta,Par)
% sloving following KBR-based tensor recovery problem.
% min_X P_ls( C ) + lambda Prod_j{(P_ls^*( M_j(j))} + beta/(-2log(eps))*| Y - ttm(C,{U_1,U_2,...,U_N}) |_F^2
