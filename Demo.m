...
%
% See also KBR_DeNoising TensorDL, ksvddenoise, bm3d, NLM3D, bm4d, LRTA, PARAFAC and MSIQA
%
...
EN_BWKSVD   = 1;  % set to 0 for turning off;
EN_BWBM3D   = 1;
EN_KSVD     = 1;
EN_NLM3D    = 1;
EN_LRTA     = 1;
...
getImage    = 1; % if save the appointed band of the reconstructed MSI as image result or not
mkdir(saveroad);
rng(1);
%% initial Data
methodname ={'Nosiy','BWKSVD','BWBM3D','KSVD','NLM3D','LRTA','PARAFAC','Trace-TV','TDL','BM4D','tSVD','KBR'};
...
fprintf('================== Result =====================\n');
close all;
showMSIResult(Re_msi,Omsi,minI,maxI,methodname,enList,band)
